...
public class LinkedListDequeTest extends DequeTest{

    public LinkedListDequeTest() {
        super(new LinkedListDeque<Integer>());
    }
    ...
    public void getTest() {
        ...
        assertTrue("(Recursive) Item at index -1 should be null", d.getRecursive(-1) == null);

        for (int i = 0; i < 3; i++) {
            assertTrue("Item at index " + i + " should be " + i + 1, d.get(i) == i + 1);
            assertTrue("(Recursive) Item at index " + i + " should be " + i + 1, d.getRecursive(i) == i + 1);
        }

        assertTrue("Item at index 5 should be null", d.get(5) == null);
        assertTrue("(Recursive) Item at index 5 should be null", d.getRecursive(5) == null);
    }
}
